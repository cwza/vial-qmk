...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		...
		KC_TRNS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(LSFT(KC_Z)), KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_CAPS, KC_TRNS,
		KC_TRNS, KC_LCTL, KC_LOPT, KC_LGUI, KC_LSFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	...
	[2] = LAYOUT(
		...
		KC_TRNS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(LSFT(KC_Z)), KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_LCTL, KC_LOPT, KC_LGUI, KC_LSFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	...
	[3] = LAYOUT(
		...
		KC_TRNS, KC_QUOT, KC_4, KC_5, KC_6, KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_GRV, KC_1, KC_2, KC_3, KC_BSLS, KC_TRNS, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, KC_TRNS,
	...
	[4] = LAYOUT(
		...
		KC_TRNS, LSFT(KC_QUOT), LSFT(KC_4), LSFT(KC_5), LSFT(KC_6), LSFT(KC_EQL), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, LSFT(KC_GRV), LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_BSLS), KC_TRNS, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, KC_TRNS,
	...
	[5] = LAYOUT(
		...
		KC_TRNS, KC_LCTL, KC_LOPT, KC_LGUI, KC_LSFT, KC_TRNS, KC_TRNS, KC_MPRV, KC_MNXT, KC_MPLY, KC_TRNS, KC_TRNS,
		_______, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, _______
	),
	[6] = LAYOUT(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_F4, KC_F5, KC_F6, KC_F11, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F10, KC_TRNS, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, KC_TRNS,
		_______, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, _______
	)
};
...
smtd_resolution on_smtd_action(uint16_t keycode, smtd_action action, uint8_t tap_count) {
    switch (keycode) {
        SMTD_MT(KC_Z, KC_LEFT_CTRL)
        SMTD_MT(KC_X, KC_LEFT_ALT)
        SMTD_MT(KC_C, KC_LEFT_GUI)
        SMTD_MT(KC_V, KC_LEFT_SHIFT)
        SMTD_MT(KC_SLSH, KC_LEFT_CTRL)
        SMTD_MT(KC_DOT, KC_LEFT_ALT)
        SMTD_MT(KC_COMM, KC_LEFT_GUI)
        SMTD_MT(KC_M, KC_LEFT_SHIFT)
        SMTD_LT(KC_SPC, 1)
        SMTD_LT(KC_TAB, 2)
        SMTD_LT(KC_BSPC, 3)
        SMTD_LT(KC_ENT, 4)
