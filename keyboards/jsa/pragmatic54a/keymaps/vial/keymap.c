...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		...
		KC_TRNS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(LSFT(KC_Z)), KC_TRNS, QK_MACRO_0, QK_MACRO_2, QK_MACRO_1, KC_TRNS, KC_TRNS,
	...
	[2] = LAYOUT(
		...
		KC_TRNS, LSFT(KC_7), LSFT(KC_8), KC_MINS, LSFT(KC_MINS), LSFT(KC_5), LSFT(KC_GRV), OSM(MOD_RGUI), OSM(MOD_RSFT), OSM(MOD_RALT), OSM(MOD_RCTL), KC_TRNS,
		KC_TRNS, LSFT(KC_BSLS), LSFT(KC_2), KC_EQL, LSFT(KC_EQL), LSFT(KC_3), KC_TRNS, LSFT(KC_1), LSFT(KC_COMM), LSFT(KC_DOT), KC_TRNS, KC_TRNS,
		_______, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, _______
	),
	[3] = LAYOUT(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
