...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		...
		KC_F13, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_F13,
		_______, MO(4), KC_SPC, MO(1), MO(2), KC_LSFT, KC_TRNS, _______
	),
	[1] = LAYOUT(
		...
		KC_TRNS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(LSFT(KC_Z)), KC_TRNS, LGUI(KC_SPC), LGUI(LSFT(KC_SPC)), KC_TRNS, KC_CAPS, KC_TRNS,
	...
	[2] = LAYOUT(
		...
		KC_TRNS, LSFT(KC_LBRC), LSFT(KC_RBRC), KC_LBRC, KC_RBRC, KC_EQL, LSFT(KC_MINS), OSM(MOD_RGUI), OSM(MOD_RSFT), OSM(MOD_RALT), OSM(MOD_RCTL), KC_TRNS,
		KC_TRNS, KC_BSLS, KC_GRV, KC_MINS, LSFT(KC_DOT), LSFT(KC_EQL), LSFT(KC_BSLS), LSFT(KC_COMM), LSFT(KC_SLSH), LSFT(KC_GRV), KC_SLSH, KC_TRNS,
		_______, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, _______
	),
	[3] = LAYOUT(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
